    ...
    >
      ...
      <div className="status-col">
        <button
          ...
          onClick={(e) => onToggleStatus(e, bill.id)}
          onPointerUp={(e) => onToggleStatus(e, bill.id)}
      ...
      <div className="phone-card">
        <div className="top-section">
          ...
          <div className="utility-row">
            <button className="mini-btn touch-btn" type="button" onClick={handleEnableNotifications} onPointerUp={handleEnableNotifications}>
              <Bell size={15} />
