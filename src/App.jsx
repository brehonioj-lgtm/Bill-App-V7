...
export default function App() {
  ...
  useEffect(() => {
    try {
      ...
      console.log('Install prompt listener error:', err);
    }
  }, []);
  ...
  useEffect(() => {
    try {
      ...
      console.log('App installed listener error:', err);
    }
  }, []);
  ...
  async function installApp() {
    try {
      ...
      console.log('Install app error:', err);
    }
  }
      ...
      <div className="phone-card">
        <div className="top-section">
          ...
          <div className="utility-row">
            <button className="mini-btn" type="button" onClick={enableNotifications}>
              <Bell size={15} />
              {notificationPermission === 'granted' ? 'Alerts On' : 'Enable Alerts'}
            </button>

            {installAvailable ? (
              <button className="mini-btn" type="button" onClick={installApp}>
                <Download size={15} />
                Install App
              </button>
            ) : null}
